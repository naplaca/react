...
interface LogoProps extends Omit<BoxProps, "children" | "ref">, ElementProps<"svg", keyof BoxProps> {
  size?: string | number;
  to?: string;
}

export function Logo({ size, style, to, ...props }: LogoProps) {
  const logo = (
    <Box
      component="svg"
    ...
    >
      ...
      <path opacity=".5" d="M4 4m0 1a1 1 0 0 1 1 -1h4a1 1 0 0 1 1 1v4a1 1 0 0 1 -1 1h-4a1 1 0 0 1 -1 -1z" />
      <path d="M7 17l0 .01" />
